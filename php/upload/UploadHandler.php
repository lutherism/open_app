...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            'script_url' => 'http://store.openrobot.net/php/upload/',
            'upload_dir' => '/home1/open/public_html/open_app/images/robots/',
            'upload_url' => 'http://store.openrobot.net/images/robots/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
